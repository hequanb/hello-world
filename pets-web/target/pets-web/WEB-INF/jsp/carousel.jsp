		...
		<div id="main" >
			<div class="layui-carousel" id="test1">
				<div carousel-item>
					...
					<div style="background:url('${pageContext.request.contextPath }/images/data/slide2.jpg') no-repeat; background-size:100% 100%;">>条目2</div>
					<div style="background-color:grey">条目3</div>
				</div>
			</div>
		</div>
	</div>
