...
<%@ include file="/WEB-INF/jsp/adminIndex.jsp" %>
		...
		<form lay-filter="addItemForm" class="layui-form" method="post" enctype="multipart/form-data">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="title" required lay-verify="required" placeholder="请输入商品标题.."/>
				</div>
			</div>  
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">商品卖点:</label>
				<div class="layui-input-block">
				  <textarea name="sellPoint" placeholder="请输入商品卖点.." maxlength="500" class="layui-textarea"></textarea>
				</div>
	  		</div>
	  		<div class="layui-form-item">
				<label class="layui-form-label">商品价钱:</label>
				<div class="layui-input-inline">
					<input type="number" name="price" lay-verify="price|required|number" required placeholder="请输入商品价钱.." step="0.01" autocomplete="off" class="layui-input">
				</div>
	  		...
	  		<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="brand" required lay-verify="required" placeholder="请输入商标.."/>
				</div>
			</div> 
			<div class="layui-form-item">
				<label class="layui-form-label">规格:</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="standard" required lay-verify="required" placeholder="请输入商品规格.."/>
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="target" required lay-verify="required" placeholder="请输入适用对象.."/>
				</div>
			</div> 
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number" name="num" lay-verify="required|number|num" required placeholder="请输入库存量.." step="1" autocomplete="off" class="layui-input">
				</div>
			...
			<!-- 接收回调的图片url -->
			<input type="hidden" name="image" id="image" autocomplete="off" class="layui-input">
			
			<div class="layui-form-item">
			    <div class="layui-input-block">
			      <button class="layui-btn" lay-submit lay-filter="addItemFormSubmit">立即提交</button>
	...
	<script>
		...
		layui.use(['form','upload'], function(){
		  ...
		  //监听提交
			form.on('submit(addItemFormSubmit)', function(data){
				$.ajax({
					url : "${pageContext.request.contextPath}/item/addItem"
